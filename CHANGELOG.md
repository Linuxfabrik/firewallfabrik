...
* Compiler (nftables): a rule whose service element is negated and names several users keeps its negation - one rule per user matches every packet, because a socket has one owner.
