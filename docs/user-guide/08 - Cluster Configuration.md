...
![Failover group objects and mapping between cluster and member interfaces](img/cluster-failover-group-mapping.png)
...
![Failover Group object configuration](img/cluster-failover-group-config.png)
...
![Editing parameters for the heartbeat protocol](img/cluster-heartbeat-parameters.png)

![Editing parameters for the OpenAIS protocol](img/cluster-openais-parameters.png)
...
![State synchronization group object in the tree](img/cluster-state-sync-group-tree.png)

The State Synchronization group object should look like this:

![State synchronization group object parameters](img/cluster-state-sync-group-parameters.png)
...
![Editing parameters for the Conntrack state synchronization protocol](img/cluster-conntrack-parameters.png)
...
![A warning shown when a rule set that belongs to the member firewall overrides rule set that belongs to the cluster](img/cluster-rule-set-override-warning.png)
