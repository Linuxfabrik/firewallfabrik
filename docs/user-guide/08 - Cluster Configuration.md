...
Supported State Synchronization and Failover Software
...
Detailed description of the Cluster object is provided in [05 - Working with Objects](05%20-%20Working%20with%20Objects.md).

## Linux cluster configuration with FirewallFabrik

Detailed walk-through examples for Linux cluster configurations can be found in [14 - FirewallFabrik Cookbook](14%20-%20FirewallFabrik%20Cookbook.md).
...
<figure>
<img src="img/cluster-failover-group-mapping.png" alt="img/cluster-failover-group-mapping.png" />
<figcaption>Failover group objects and mapping between cluster and member interfaces</figcaption>
</figure>
...
<figure>
<img src="img/cluster-failover-group-config.png" alt="img/cluster-failover-group-config.png" />
<figcaption>Failover Group object configuration</figcaption>
</figure>
...
<figure>
<img src="img/cluster-heartbeat-parameters.png" alt="img/cluster-heartbeat-parameters.png" />
<figcaption>Editing parameters for the heartbeat protocol</figcaption>
</figure>

<figure>
<img src="img/cluster-openais-parameters.png" alt="img/cluster-openais-parameters.png" />
<figcaption>Editing parameters for the OpenAIS protocol</figcaption>
</figure>
...
<figure>
<img src="img/cluster-state-sync-group-tree.png" alt="img/cluster-state-sync-group-tree.png" />
<figcaption>State synchronization group object in the tree</figcaption>
</figure>

The State Synchronization group object should look like this:

<figure>
<img src="img/cluster-state-sync-group-parameters.png" alt="img/cluster-state-sync-group-parameters.png" />
<figcaption>State synchronization group object parameters</figcaption>
</figure>

Member firewalls and their interfaces appear in the panel in the right hand side of the dialog. FirewallFabrik uses this information to automatically generate iptables rules to permit conntrackd packets. FirewallFabrik assumes conntrackd is configured to send synchronization packets over dedicated interface (which generally is a good idea anyway). You may use internal interface of the firewall for this purpose as well. See examples of conntrackd configuration in [14 - FirewallFabrik Cookbook](14%20-%20FirewallFabrik%20Cookbook.md). You can configure ip address and port number for the conntrack as well.

<figure>
<img src="img/cluster-conntrack-parameters.png" alt="img/cluster-conntrack-parameters.png" />
<figcaption>Editing parameters for the Conntrack state synchronization protocol</figcaption>
</figure>
...
<figure>
<img src="img/cluster-rule-set-override-warning.png" alt="img/cluster-rule-set-override-warning.png" />
<figcaption>A warning shown when a rule set that belongs to the member firewall overrides rule set that belongs to the cluster</figcaption>
</figure>
