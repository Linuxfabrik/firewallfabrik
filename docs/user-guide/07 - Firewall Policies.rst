...
.. figure:: img/rcs-initial-file.png
   :alt: Firewall Builder with test2.fwb open

   Firewall Builder with test2.fwb open
...
.. figure:: img/rcs-file-properties-empty.png
   :alt: File Properties dialog before revision control

   File Properties dialog before revision control

To start tracking revisions of this data file, use menu File/Add File to RCS, the program creates all necessary files and reports result in a pop-up dialog. If for some reason adding file to the revision control has failed, the program reports error in the same pop-up dialog. :doc:`15 - Troubleshooting` has a list of typical problems that may occur at this point.

.. figure:: img/rcs-add-file-to-rcs-menu.png
   :alt: Adding a file to RCS using the File menu

   Adding a file to RCS using the File menu

.. figure:: img/rcs-add-file-confirmation.png
   :alt: Confirmation that the file has been added to RCS

   Confirmation that the file has been added to RCS
...
.. figure:: img/rcs-file-rev-1-1.png
   :alt: Firewall Builder showing revision 1.1 in the title bar

   Firewall Builder showing revision 1.1 in the title bar
...
.. figure:: img/rcs-file-properties-rev-1-1.png
   :alt: File Properties showing revision 1.1

   File Properties showing revision 1.1
...
.. figure:: img/rcs-policy-five-rules.png
   :alt: Policy with five rules

   Policy with five rules

Now we add one more rule (to permit *HTTP* to the firewall). This is rule #3; it is colored yellow:

.. figure:: img/rcs-policy-http-added.png
   :alt: Policy with HTTP rule added

   Policy with HTTP rule added
...
.. figure:: img/rcs-checkin-dialog.png
   :alt: Log record for the new revision

   Log record for the new revision
...
.. figure:: img/rcs-revision-list-1-1.png
   :alt: RCS File Preview showing revision 1.1 selected

   RCS File Preview showing revision 1.1 selected

.. figure:: img/rcs-revision-list-1-2.png
   :alt: RCS File Preview showing revision 1.2 selected

   RCS File Preview showing revision 1.2 selected

If we choose revision *1.2* (the latest) and click Open, we see the rule that permits HTTP to the firewall:

.. figure:: img/rcs-file-rev-1-2.png
   :alt: Firewall Builder showing revision 1.2

   Firewall Builder showing revision 1.2
...
.. figure:: img/rcs-file-rev-1-1-opened.png
   :alt: Firewall Builder showing revision 1.1

   Firewall Builder showing revision 1.1
...
.. figure:: img/rcs-policy-smtp-added.png
   :alt: Policy with SMTP service added in revision 1.1

   Policy with SMTP service added in revision 1.1
...
.. figure:: img/rcs-revision-branch.png
   :alt: RCS File Preview showing branch revision 1.1.1.1

   RCS File Preview showing branch revision 1.1.1.1
