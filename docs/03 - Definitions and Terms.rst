...
Firewall
   The term *firewall* can refer to a device that implements firewall software, or it can refer to the complete set of software and policies running on the device, or it can refer to just a firewall access policy.
...
Policy
   The term *policy* can refer to the entire set of "business logic" that is implemented in the firewall or it can refer to the access policy portion of firewall only.
