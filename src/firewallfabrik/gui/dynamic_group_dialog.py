...
class DynamicGroupDialog(BaseObjectDialog):
    """Editor for DynamicGroup objects (name + comment/keywords).

    The full criteria table with type/keyword filters (matching
    fwbuilder's DynamicGroupDialog) is deferred to a later iteration.
    """
